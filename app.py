...
def graph2():
  ...
  df = pd.DataFrame({ 'Municipalities' : towns,'pct' : pctDiff})
  plot = Bar(df, 'Municipalities', values='% difference (actual vs. predicted)', title="Under-/Over-valued municipalities")
